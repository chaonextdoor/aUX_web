/**
 * aUX.web.alphaTable - a list table for AppMobi/css3
 * 
...
aUX.web.alphaTable = (function() {
	...
	var alphaTable = function(el, scroller,opts) {
		...
		{
		    return alert("Error: Please include an aUX.web.scroll object to use this");
		}
	...
	alphaTable.prototype = {
		...
		setupIndex:function(){
			...
			containerDiv.style.cssText="position:absolute;top:10px;left:300px;width:20px;font-size:8pt;font-weight:bold;color:#000;opacity:.5;border-radius:5px;text-align:center;z-index:9999;border:1px solid black;background:#666;padding-top:5px;padding-bottom:5px;";
