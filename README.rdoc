...
AppMobi.toolkit is a helper library for writing mobile web apps and AppMobi apps.
...
appmobi.toolkit.web.min.js contains a minified version of functions that can be used for mobile web development
appmobi.toolkit.am.min.js contains the appmobi specific functions.
appmobi.toolkit.all.min.js contains all the toolkit functions
...
AppMobi.toolkit.social (coming soon in 3.4.1)
